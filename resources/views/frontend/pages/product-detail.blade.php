        ...
        <div class="row px-xl-5">
            ...
            <div class="col-lg-7 pb-5">
                ...
                <div class="d-flex align-items-center mb-4 pt-2">
                    <h3 class="font-weight-semi-bold mr-3">{{number_format($product->price,0,',','.').'đ'}}</h3>
                ...
                @if($product->stock == 0)
                    <h3 style="background: red; width: 180px; font-weight: 600; text-align: center">Out of Stock</h3>
                @else
                    <div class="d-flex align-items-center mb-4 pt-2">
